...
function GalleryPage() {
  ...
  const galleryData = {
    ...
    teacher: [
      { src: '/gallery/teacher/bonfire-dance.jpg', title: 'Soul on Fire', meta: 'Oil on canvas', artist: 'Milky', date: '', desc: '' },
      { src: '/gallery/teacher/the-violinist.jpg', title: 'Free Spirit', meta: 'Oil on canvas', artist: 'Milky', date: '', desc: '' },
      ...
      { src: '/gallery/teacher/yellow-boat.jpg', title: 'Still Water', meta: 'Acrylic on canvas', artist: 'Milky', date: '', desc: '' },
    ],
  };
