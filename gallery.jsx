...
function GalleryPage() {
  ...
  const galleryData = {
    ...
    teacher: [
      { src: '/gallery/teacher/bonfire-dance.jpg', title: 'Bonfire Dance', meta: 'Oil on canvas', artist: 'Milky', date: '', desc: '' },
      { src: '/gallery/teacher/the-violinist.jpg', title: 'The Violinist', meta: 'Oil on canvas', artist: 'Milky', date: '', desc: '' },
      { src: '/gallery/teacher/rainbow-purim.jpg', title: 'Rainbow Purim', meta: 'Oil on canvas', artist: 'Milky', date: '', desc: '' },
      { src: '/gallery/teacher/red-haired-portrait.jpg', title: 'Red-Haired Portrait', meta: 'Oil on canvas', artist: 'Milky', date: '', desc: '' },
      { src: '/gallery/teacher/sepia-self-portrait.jpg', title: 'Sepia Self Portrait', meta: 'Oil on panel', artist: 'Milky', date: '', desc: '' },
      { src: '/gallery/teacher/portrait-in-red.jpg', title: 'Portrait in Red', meta: 'Oil on canvas', artist: 'Milky', date: '', desc: '' },
      { src: '/gallery/teacher/winter-figures.jpg', title: 'Winter Figures', meta: 'Mixed media', artist: 'Milky', date: '', desc: '' },
      { src: '/gallery/teacher/birds-of-mind.jpg', title: 'Birds of the Mind', meta: 'Oil on canvas', artist: 'Milky', date: '', desc: '' },
      { src: '/gallery/teacher/purim-girl.jpg', title: 'Purim Girl', meta: 'Oil on canvas', artist: 'Milky', date: '', desc: '' },
      { src: '/gallery/teacher/yellow-boat.jpg', title: 'Yellow Boat', meta: 'Oil on canvas', artist: 'Milky', date: '', desc: '' },
    ],
  };
